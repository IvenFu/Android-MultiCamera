...
public class Camera2BasicFragment extends Fragment
    ...
    private final Object mIsRunning = new Object();
    ...
    private final TextureView.SurfaceTextureListener mSurfaceTextureListener
        ...
        public void onSurfaceTextureSizeChanged(SurfaceTexture texture, int width, int height) {
            Log.i(TAG, "onSurfaceTextureChanged width: " + width + " height " + height);
     ...
     * {@link TextureView}.
     */
    private final TextureView.SurfaceTextureListener mSurfaceTextureListener2
            = new TextureView.SurfaceTextureListener() {
        ...
        @Override
        public void onSurfaceTextureSizeChanged(SurfaceTexture texture, int width, int height) {
            Log.i(TAG, "onSurfaceTextureChanged 2 width: " + width + " height " + height);
            //configureTransform(width, height);
        }
    ...
    public void onResume() {
        ...
        if (mTextureView.isAvailable() && mTextureView2.isAvailable()) {
    ...
    private void openCamera(int width, int height) {
        ...
        synchronized (mIsRunning) {
            if (mIsCameraRunning.getAndSet(true)) {
    ...
    private void createCameraPreviewSession() {
        try {
            ...
            if(texture == null || texture2 == null){
                Log.e(TAG, "createCameraPreviewSession texture == null");
                synchronized(mIsRunning){
                    mIsCameraRunning.getAndSet(false);
                }
                return ;
            }
            ...
            mCameraDevice.createCaptureSession(Arrays.asList(surface, surface2),
